...
public class UpstreamFailureTests
{
    ...
    public async Task Refresh_DiscardsCycle_WhenAnyItemFetchFails()
    {
        ...
        api.Services.GetRequiredService<IStorySnapshot>().Read().Stories.Count.ShouldBe(3);
    }
    ...
    public async Task Refresh_SkipsNullItems_AndStillPublishes()
    {
        ...
        api.Services.GetRequiredService<IStorySnapshot>().Read().Stories.Count.ShouldBe(2);
    }
    ...
    public async Task Refresh_SkipsDeletedAndDeadItems(string withdrawal)
    {
        ...
        var snapshot = api.Services.GetRequiredService<IStorySnapshot>().Read().Stories;
    ...
    public async Task Refresh_RecoversAfterUpstreamReturns()
    {
        ...
        api.Services.GetRequiredService<IStorySnapshot>().Read().Stories[0].Title.ShouldBe("Newly top");
    }
